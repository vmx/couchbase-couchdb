...
% The size of the accumulator the items are queued up in before they get
% actually queued. The bigger the value, the less the lock contention, but
% the higher the possible memory consumption is.
